...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","1. Navigation","2. Order Tab","3. Second topic","1.1. Application Tabs","1.2. Main Menu","2.1. Collapsable Panes"],
    DREX_NODE_LINKS: ["index.htm","navigation.htm","order_tab.htm","second_topic.htm","application_tabs.htm","main_menu.htm","collapsable_panes.htm"],
    DREX_NODE_CHILD_START: [1,4,6,7,7,7,7],
    DREX_NODE_CHILD_END: [4,6,7,7,7,7,7],
    DREX_MENU_TYPE: 2,
